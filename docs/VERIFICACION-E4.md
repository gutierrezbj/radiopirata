...
- Cada reloj va en su propio recuadro con un marco fino amarillo, y los dos en fila: «Allí, en Caracas» con «por la mañana» debajo, y «Aquí» con «donde tú estás». Comprobado que caben lado a lado en el panel de escritorio y en móvil, también con «Ciudad de México». La primera versión rellenó el recuadro de amarillo entero y JuanCho lo tumbó con razón: demasiado.
- De paso: la etiqueta del globo pintaba «M?xico» porque la fuente de la librería no tiene acentos. Ahora el nombre sobre el globo va sin tildes; el nombre completo sigue en el panel.
